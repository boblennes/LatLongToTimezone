...
/**
 * LatLongToTimezone Conversion Library for Codeigniter/Bonfire.
 *
 * Latitude / Longitude Conversion To Timezone within 35 miles accuracy,
 * without using external database.  
 * Useful for timezone of a zipcode.
 * (major kudos to Tim Cooper who converted the shapefile)
 * Reference: http://en.wikipedia.org/wiki/Shapefile 
 * Shapefile: http://efele.net/maps/tz/world/
 * 
 * @version 0.1
 * @author Bob L <info@visualsolutions-inc.com>
 * @company Visual Solutions, Inc. http://visualsolutions-inc.com
 *
 */
